...
description: >
  ...
  Déclencher uniquement sur demande explicite d'un audit de sécurité, vérification
  des vulnérabilités ou des dépendances. Ne pas déclencher implicitement.
---

Lire AGENTS.md pour connaître le stack, les mécanismes de sécurité et les dépendances du projet.
