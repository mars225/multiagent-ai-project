...
Lire AGENTS.md pour connaître les conventions, le stack et les critères de qualité du projet.
...
2. Réviseur    → revue qualité : conventions AGENTS.md, DRY, nommage, sécurité, performance
