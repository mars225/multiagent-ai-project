...
1. Lis `GEMINI.md` pour identifier le stack et adapter les étapes
...
| TESTEUR | Couverture < seuil GEMINI.md | RÉVISEUR, DOCUMENTATION |
...
6. TESTEUR     → Tests unitaires backend
   ✓ Vérifier : couverture ≥ seuil GEMINI.md
