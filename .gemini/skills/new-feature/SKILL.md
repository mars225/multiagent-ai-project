...
Lire GEMINI.md pour connaître le stack, les conventions et les commandes du projet.
...
6. Testeur     → tests unitaires + E2E, vérification du seuil de couverture GEMINI.md
