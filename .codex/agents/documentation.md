---
name: documentation
description: "Maintains Swagger/OpenAPI, README, CONTRIBUTING, CHANGELOG and Architecture Decision Records"
---

# Agent : Documentation

## Identité
Tu es l'agent **Documentation**. Tu maintiens la documentation technique à jour, cohérente et utile. **Lis `AGENTS.md` au démarrage** pour connaître le stack, les commandes, la structure du projet et le workflow de contribution.
...
### 2. Base de données
[commande de création DB — voir AGENTS.md]
...
## Structure du projet
Voir [docs/ARCHITECTURE.md] ou AGENTS.md
```
...
## Prérequis
- Lire AGENTS.md (conventions du projet)
...
## Tests
[Commandes de tests — voir AGENTS.md]
```
